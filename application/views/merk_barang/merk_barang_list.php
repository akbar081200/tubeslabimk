        ...
        <th>Action</th>
            ...
            <td style="text-align:center" width="200px"> 
                <a data-toggle="tooltip" data-placement="top" title="Edit">
                      <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#myModalEdit<?php echo $merk_barang->id_merk; ?>"><i class="fa fa-edit"></i></button>
                      </a>
                       <a href="<?php echo base_url('merk_barang/delete/'.$merk_barang->id_merk); ?>" data-toggle="tooltip" data-placement="top" title="Delete" onclick="return confirm('Hapus Data Barang <?php echo $merk_barang->merk_barang; ?> ?')">
